...
@WebServlet("/verify-schedule-transfer")
public class ScheduleVerifyTransfer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean status = scheduleTransferService.scheduleTransferConfirm(Long.parseLong(id), otp);
