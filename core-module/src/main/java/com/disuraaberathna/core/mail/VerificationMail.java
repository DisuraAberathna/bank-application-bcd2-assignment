...
public class VerificationMail extends Mailable {
    ...
    public void build(Message message) throws Exception {
        ...
        String mailBody = "<div style='font-family: Arial, sans-serif; background-color: #fff; padding: 20px;'>\n" +
                "  <div style='margin: auto; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);'>\n" +
